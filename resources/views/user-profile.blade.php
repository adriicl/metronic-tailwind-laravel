                        ...
                        <table class="table align-middle text-sm text-gray-500">
                                                ...
                                                <div class="image-input size-16 relative" data-image-input="true">
                                                      ...
                                                      <div class="image-input-placeholder rounded-full border-2 border-success image-input-empty:border-gray-300"
                                                            ...
                                                            <div class="image-input-preview rounded-full"
                                                                  style="background-image:url('{{ asset('assets/media/avatars/300-2.png') }}')">
                                                            </div>
                                                            <div
                                                                  ...
                                                                  <svg class="fill-light opacity-80" height="12"
                                                                        ...
                                                                        <path d="M11.6665 2.64585H11.2232C11.0873...Z"
                                                                              fill="" />
                                                                        <path d="M7 8.77087C8.20812 8.77087..."
                                                                              fill="" />
                                                                  </svg>
                                                            </div>
                                                      </div>
                                                      <button type="button"
                                                            ...
                                                            onclick="removeAvatar()" data-tooltip="#image_input_tooltip"
                              ...
                              <tr>
                                    ...
                                    <td class="py-2 text-gray-800 font-normal text-sm">
                                          <span id="name-display">{{ $lastUser->name ?? 'No Name Found' }}</span>
                                          <input type="text" name="name" id="name" value="{{ $lastUser->name ?? '' }}"
